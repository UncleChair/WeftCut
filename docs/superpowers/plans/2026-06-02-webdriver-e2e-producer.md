...
**Assets:** external, via `WEFTCUT_TEST_MEDIA` env (default `C:/Users/iClass/Desktop/learning/testfile`); clip `test_1080p_30fps.mp4`. If the dir is absent, the spec SKIPS with a logged notice (Task 3).
...
const MEDIA_DIR = process.env.WEFTCUT_TEST_MEDIA
  || "C:/Users/iClass/Desktop/learning/testfile";
