...
- Branch / venue: implement in the **`wt1`** worktree (`C:/Users/jonny/Desktop/learning/videtor-wt1`), already fast-forwarded to the migration branch. All paths below are relative to `apps/desktop/` inside that worktree unless noted.
