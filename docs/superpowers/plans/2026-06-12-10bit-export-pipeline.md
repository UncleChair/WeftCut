...
```js
const a = { mode:"ws", width:128, height:128, fpsNum:30, fpsDen:1, codec:"hevc", bitrate:1000000, cbr:false, gop:30, software:true, outputPath: "C:\\\\Users\\\\iClass\\\\AppData\\\\Local\\\\Temp\\\\sink_smoke.mp4" };
