...
cd "$(mktemp -d)" && for e in 709ltd 601ltd 709full 601full; do \
  go run "C:/Users/jonny/Desktop/learning/videtor/apps/desktop/e2e/fixtures/generate.go" --color $e; done && ls
```
...
- Modify: `C:\Users\jonny\.claude\projects\C--Users-jonny-Desktop-learning-videtor\memory\MEMORY.md` + a project memory file
