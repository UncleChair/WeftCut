...
- `C:/Users/iClass/Desktop/learning/testfile/generate.go` (EXTERNAL, not in repo) — `--audio` flag adds the marked audio track; regenerates `test_1080p_30fps_audio.mp4`.
...
**Files:**
- Modify: `C:/Users/iClass/Desktop/learning/testfile/generate.go` (external)
- Produces: `C:/Users/iClass/Desktop/learning/testfile/test_1080p_30fps_audio.mp4`
...
```bash
cd /c/Users/iClass/Desktop/learning/testfile && go run generate.go --fps 30 --format mp4 --audio
```
...
```bash
FP=/c/Users/iClass/AppData/Local/Microsoft/WinGet/Links/ffprobe.exe
...
```bash
FF=/c/Users/iClass/AppData/Local/Microsoft/WinGet/Links/ffmpeg.exe
...
cargo run --manifest-path apps/desktop/src-tauri/Cargo.toml --bin media_conformance --quiet -- \
  --audio --output "C:/Users/iClass/Desktop/learning/testfile/test_1080p_30fps_audio.mp4" \
  --source "C:/Users/iClass/Desktop/learning/testfile/test_1080p_30fps_audio.mp4"
```
...
```bash
npm --prefix "C:/Users/iClass/Desktop/learning/videtor/apps/desktop/e2e" test
```
