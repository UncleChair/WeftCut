...
- Branch / venue: `wt1` worktree (`C:/Users/iClass/Desktop/learning/videtor-wt1`), continuing the PoC commits. Paths below are relative to `apps/desktop/` unless noted, except `docs/`.
