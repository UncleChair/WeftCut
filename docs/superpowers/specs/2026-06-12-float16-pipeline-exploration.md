...
Status: **probes RUN 2026-06-12 (results below); architecture design
still open.** ADR 0021 (color converges at ingest; working space =
output space) remains the current model; this is the concrete shape of
its named revisit trigger. Probe vehicle:
