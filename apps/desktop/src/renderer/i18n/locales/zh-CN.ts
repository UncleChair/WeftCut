...
const zhCN: Resources = {
  ...
  export_dialog: {
    ...
    range_out: "出点",
    range_duration: "时长",
    range_duration_wall_clock: "实际 {{wall}}（非丢帧时间码）",
  ...
  connect: {
    blurb: "选择你的 Agent 客户端，然后让 Agent 自动配置 MCP，或手动添加连接。",
    starting: "MCP 服务正在启动…",
    copy: "复制配置",
    copied: "已复制！",
    copy_prompt: "复制配置提示词",
    prompt_copied: "提示词已复制！",
    prompt_heading: "让 Agent 自动配置",
    prompt_blurb: "复制为 {{client}} 准备的提示词，然后粘贴到 Agent 对话中。",
    manual_heading: "或手动配置",
    agent_prompt: [
      "请在这台电脑上为 {{client}} 配置 WeftCut MCP 服务。请直接完成配置修改，不要只告诉我操作步骤。",
      "",
      "请使用以下准确的 MCP 服务配置：",
      "```",
      "{{snippet}}",
