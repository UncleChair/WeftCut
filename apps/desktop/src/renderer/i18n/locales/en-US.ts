...
const enUS = {
  ...
  connect: {
    blurb:
      "Choose your agent client, then let the agent set up MCP or add the connection manually.",
    starting: "MCP server starting…",
    copy: "Copy config",
    copied: "Copied!",
    copy_prompt: "Copy setup prompt",
    prompt_copied: "Prompt copied!",
    prompt_heading: "Set up with your agent",
    prompt_blurb:
      "Copy a ready-made prompt for {{client}}, then paste it into the agent chat.",
    manual_heading: "Or configure manually",
    agent_prompt: [
      "Configure the WeftCut MCP server for {{client}} on this machine. Make the configuration change yourself; do not just describe the steps.",
      "",
      "Use this exact MCP server definition:",
      "```",
      "{{snippet}}",
      "```",
      "",
      "Client-specific placement guidance: {{hint}}.",
      "",
      "Requirements:",
