...
const enUS = {
  ...
  property_panel: {
    ...
    enabled: "Enabled",
    t_start_s: "Start (s)",
    t_start_s_hint: "Inclusive — frame at this time is the layer's first.",
    t_end_s: "End (s)",
    t_end_s_hint: "Exclusive — the boundary AFTER the layer's last frame. A layer ending at 10.000 in a 30 fps comp keeps frame 299 (anchored at 9.967); use 9.967 here to drop that frame.",
    text: "Text",
    content: "Content",
