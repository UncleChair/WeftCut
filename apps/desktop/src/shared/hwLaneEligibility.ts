...
// One shared home consulted from BOTH sides of the probe: the renderer's
// probe-kick gate (`hwEligibleCodec`,
...
/// The seek-validated gate every lane except videotoolbox keeps: codec ∈
/// {h264, hevc, vp9} AND an 8-bit pixel format.
...
/// - `nvdec` / `vaapi` / `d3d11va`: `eligibleEightBitInterframe`.
