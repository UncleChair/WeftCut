...
import { TemplateHandle } from "./handles/TemplateHandle";
...
function createHandle(layer: LayerSummary, ctx: HandleContext): LayerHandle | null {
  switch (layer.params.kind) {
    ...
    case "Template":
      return new TemplateHandle(ctx);
    case "Subtitles":
      // Phase D (Subtitles libass-wasm). Layer renders an empty
      // stub until then; the export path still produces them
      // correctly.
      return null;
  }
}
