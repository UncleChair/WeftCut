...
describe('routeChannel', () => {
  ...
  it('forwards independent stores + media/jobs/export to rust', () => {
    for (const ch of ['app_settings_get','app_settings_set','view_state_get','export_settings_get','recents_list','keybindings_get','agent_session_get','log_list','import_media','ensure_full_proxy','export_video_sink_start','list_motifs','settings_test_provider','workspace_dir','ping'])
