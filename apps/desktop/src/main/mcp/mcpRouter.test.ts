...
describe('routeMcpTool', () => {
  ...
  it('routes import_media + apply_subtitles to the native-compute → TS-write hybrid', () => {
  ...
  it('blocks the not-yet-ported hybrids + Phase-4 tools', () => {
    for (const t of ['synthesize_speech', 'install_motif', 'acknowledge_motif_staleness', 'motif_staleness_report', 'add_motif', 'project_restore_checkpoint'])
