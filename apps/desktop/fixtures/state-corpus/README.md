...
- `oracle/` — canonical driver output committed alongside the sequences (frozen; see below)
- `oracle-summary/` — parallel oracle set for the renderer IPC read-view (frozen; see below)
